...
public class BoiaMove : MonoBehaviour
{
    ...
    private void Raycast()// Checa pra ver se onde a boia vai �  �gua ou terra
    {

        if (Physics2D.CircleCast(transform.position, _rayRadius, Vector2.zero,1f,TerrnoAndPlayer))// Se for terra fica vermelho e n�o deixa jogar a boia
        {
        ...
        else//Se For �gua fica azul e deixa jogar a boia
        {
