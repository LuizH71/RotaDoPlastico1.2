...
public class Rescue : MonoBehaviour
{
    ...
    public static UnityAction<bool> _rescuing;// Cria uma a��o/event que passa um bool. Esse evento � especialmente
    // para a classe, ButtonFeedback, com essa informa��o ele vai saber se o bot�o na HUD deve estar pressionado ou n�o
    void Start()
    {
